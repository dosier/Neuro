...
internal class MomentumTest {
    ...
    fun testMomentumWeightUpdate(){
        val W = DoubleMatrix(2, 3, doubleArrayOf(2.0, 3.0, 4.0, 3.0, 4.0, 5.0))
        val dW = DoubleMatrix(2, 3, doubleArrayOf(.2, .3, .4, .3, .4, .5))
    ...
    fun testMomentumBiasUpdate(){
        val bias = DoubleVector(2.0, 3.0, 4.0)
        val db = DoubleVector(0.2, 0.3, 0.4)
        val o = Momentum(0.05)
