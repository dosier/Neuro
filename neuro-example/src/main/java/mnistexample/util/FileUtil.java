package mnistexample.util;

import mnistexample.DigitData;
...
public class FileUtil {
    ...
    public static List<DigitData> loadImageData(String filePrefix) {
        ...
        try (
                DataInputStream imageIS = new DataInputStream(new FileInputStream(Paths.get("data", imgFileName).toFile()));
                DataInputStream labelIS = new DataInputStream(new FileInputStream(Paths.get("data", lblFileName).toFile()));
        ) {
